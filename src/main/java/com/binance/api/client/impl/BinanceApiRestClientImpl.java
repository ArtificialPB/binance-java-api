...
public class BinanceApiRestClientImpl implements BinanceApiRestClient {
  ...
  public BinanceApiRestClientImpl(final BinanceApiService service){
  ...
  public TradeFee getTradeFee() {
    return executeSync(binanceApiService.getTradeFee(BinanceApiConstants.DEFAULT_RECEIVING_WINDOW, System.currentTimeMillis()));
  }
}
